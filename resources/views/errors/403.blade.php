        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    ...
                    @if(request()->is('admin/*'))
                        <a href="{{ route('admin.dashboard') }}" class="btn btn-lg btn-outline-primary mt-3 shadow-sm shadow-secondary">Go Dashboard</a>
                    @else
                        <a href="{{ route('user.home') }}" class="btn btn-outline-primary mt-3 shadow-sm shadow-secondary">Go Home</a>
                    @endif
                </div>
            </div>
        </div>
